  ...
  <div class="approval-container">
    <el-card>
      ...
      <el-table :data="tableData" style="width: 100%" :max-height="600">
        ...
        <el-table-column prop="scanDate" label="扫描日期" width="150" />
        ...
        <el-table-column label="操作" width="150" fixed="right">
          <template #default="scope">
            ...
            <el-button type="success" size="small" v-if="scope.row.status === 'PROCESSING'" @click="handleApproval(scope.row)">审批</el-button>
          </template>
        </el-table-column>
      </el-table>
...
const handleClaim = (row) => {
  ...
  ElMessage.success('领取成功，状态已更新为审批中')
  router.push({
    path: '/company/structure-review/detail',
    query: { applicationNo: row.applicationNo }
  })
}
